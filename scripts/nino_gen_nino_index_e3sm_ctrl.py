...
if __name__ == "__main__":
  ...
  fig_path = os.path.join(top_path,"E3SMv21_testings","paper_material","5_nino_analysis","nino_index_ts","figure")
  ...
  for exp in exps:
    for relm in relms:
      for product in products:
        ...
        ftmp = os.path.join(ptmp,'{}.{}.{}.{}.*.{}.{}*.nc'.format(mip,exp,product,relm,var,period))
        filePath = sorted(glob.glob(ftmp))
        #case = 'HIST-{}'.format(relm)
        case = product
