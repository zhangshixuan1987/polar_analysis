...
def main(fig_path,out_path,mip,exp,relm,case_id,period,pclimo,case_dict,region,regnam,season):  
  ...
  if os.path.exists(dclim):
    ...
    print('using prescribed climo file {}'.format(dclim))
  else:
    print('generating climo file {}'.format(dclim))  
  ...
  for k,regnam in enumerate(eof_region.keys()):
    ...
    for j,var in enumerate(varlist): 
      for i,product in enumerate(products):
        ...
        #clim_tmp = '{}.{}.{}.{}.climo.{}.{}.{}.{}.nc'.format(
        #            mip,exp,case,relm,case_id,vstr,regnam,pclimo)
        #use NOAA20C as climo 
        clim_tmp = '{}.{}.{}.{}.climo.{}.{}.{}.{}.nc'.format(
                    mip,exp,products[0],relm,case_id,vstr,regnam,pclimo)
